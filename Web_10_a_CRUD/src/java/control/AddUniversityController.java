...
public class AddUniversityController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (s_foundedYear == null || s_foundedYear.trim().isEmpty()) {
                error += ("Chua nhap Founded Year <br/>");
            }
            ...
            if (s_totalStudents == null || s_totalStudents.trim().isEmpty()) {
                error += ("Chua nhap Total Students <br/>");
            }
            if (s_totalFaculties == null || s_totalFaculties.trim().isEmpty()) {
                error += ("Chua nhap Total Faculties <br/>");
            }
            if (s_isDraft == null || s_isDraft.trim().isEmpty()) {
                error += ("Chua chon IsDraft <br/>");
            }
